...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $springSeason = Season::where('name', '春')->first();
        $summerSeason = Season::where('name', '夏')->first();
        $autumnSeason = Season::where('name', '秋')->first();
        $winterSeason = Season::where('name', '冬')->first();
